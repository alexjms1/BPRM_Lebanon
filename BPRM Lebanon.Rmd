...
#phase3 <- phase3[phase3$usable != "Campaign2" & !is.na(phase3$usable),]
...
tableNominal(vars = phase3 %>% select(starts_with("HelpAtt")) %>% as.data.frame, group = ID_gender[,1], cumsum = FALSE, longtable = TRUE, cap = "Descriptive statistics for help-seeking attitudes, all subjects")
```
